...
use App\Http\Controllers\Admin\payroll\BonusController;
use App\Http\Controllers\Admin\payroll\ConvenienceController;
use App\Http\Controllers\Admin\payroll\DeductionController;
use App\Http\Controllers\Admin\payroll\EmployeePortalController;
use App\Http\Controllers\Admin\payroll\EmployeeReportController;
use App\Http\Controllers\Admin\payroll\HolidayController;
use App\Http\Controllers\Admin\payroll\IdCardController;
use App\Http\Controllers\Admin\payroll\InterviewController;
use App\Http\Controllers\Admin\payroll\JobCardController;
use App\Http\Controllers\Admin\payroll\LeaveController;
use App\Http\Controllers\Admin\payroll\LettersController;
use App\Http\Controllers\Admin\payroll\LoanController;
use App\Http\Controllers\Admin\payroll\NoticeController;
use App\Http\Controllers\Admin\payroll\OffdayController;
use App\Http\Controllers\Admin\payroll\OvertimeController;
use App\Http\Controllers\Admin\payroll\PayrollManagementController;
use App\Http\Controllers\Admin\payroll\PerformanceController;
use App\Http\Controllers\Admin\payroll\PolicyController;
use App\Http\Controllers\Admin\payroll\ProbationController;
use App\Http\Controllers\Admin\payroll\ProvidentFundController;
use App\Http\Controllers\Admin\payroll\RetirementController;
use App\Http\Controllers\Admin\payroll\SalaryAdvanceController;
use App\Http\Controllers\Admin\payroll\TaxController;
use App\Http\Controllers\Admin\payroll\TerminationController;
use App\Http\Controllers\Admin\payroll\WorkingHourController;
...
Route::post('/iclock/cdata', [ZKTecoPushController::class, 'receiveData']);
    ...
    Route::get('/my-location-update',[EmployeePortalController::class,'myLocationUpdate'])->name('myLocationUpdate');
    ...
    Route::get('/daily-attendance',[AttendanceManagementController::class,'dailyAttendance'])->name('dailyAttendance');
    Route::get('/daily-attendance-print',[AttendanceManagementController::class,'dailyAttendancePrint'])->name('dailyAttendancePrint');
    Route::get('/daily-attendance-export',[AttendanceManagementController::class,'dailyAttendanceExport'])->name('dailyAttendanceExport');
    Route::any('/daily-attendance/{action}/{id?}',[AttendanceManagementController::class,'dailyAttendanceAction'])->name('dailyAttendanceAction');
    Route::get('daily-attendance-department-wise', [AttendanceManagementController::class, 'dailyAttendanceDepartmentWise'])->name('dailyAttendanceDepartmentWise');
    Route::get('daily-attendance-department-summary', [AttendanceManagementController::class,'dailyAttendanceDepartmentSummary'])->name('dailyAttendanceDepartmentSummary');
    Route::get('live-location-tracking', [EmployeePortalController::class,'liveLocationTracking'])->name('liveLocationTracking');
    ...
    Route::get('salary-report', [EmployeePortalController::class, 'gradeWiseSalaryReport'])->name('salaryReport');
    ...
    Route::get('/attendance/daily-report', [AttendanceManagementController::class, 'dailyAttendance'])->name('attendance.daily.report');
