...
<div class="col-md-4 mb-3">
    ...
    <textarea name="applicant" class="form-control" rows="2" placeholder="Applicant">{{ $pi->applicant ?? '' }}</textarea>
</div>

<div class="col-md-4 mb-3">
    <label>1st Beneficiary</label>
    <textarea name="first_beneficiary" class="form-control" rows="2" placeholder="1st Beneficiary">{{ $pi->first_beneficiary ?? '' }}</textarea>
</div>

<div class="col-md-4 mb-3">
    <label>2nd Beneficiary</label>
    <textarea name="second_beneficiary" class="form-control" rows="2" placeholder="2nd Beneficiary">{{ $pi->second_beneficiary ?? '' }}</textarea>
</div>

<div class="col-md-4 mb-3">
    <label>Applicant Bank</label>
    <textarea name="applicant_bank" class="form-control" rows="2" placeholder="Applicant Bank">{{ $pi->applicant_bank ?? '' }}</textarea>
</div>
...
<div class="col-md-4 mb-3">
    ...
    <textarea name="first_beneficiary_bank" class="form-control" rows="2" placeholder="1st Beneficiary Bank">{{ $pi->first_beneficiary_bank ?? '' }}</textarea>
</div>


<div class="col-md-4 mb-3">
    <label>2nd Beneficiary Bank</label>
    <textarea name="second_beneficiary_bank" class="form-control" rows="2" placeholder="2nd Beneficiary Bank">{{ $pi->second_beneficiary_bank ?? '' }}</textarea>
</div>

<div class="col-md-4 mb-3">
    <label>Notify Party</label>
    <textarea name="notify_party" class="form-control" rows="2" placeholder="Notify Party">{{ $pi->notify_party ?? '' }}</textarea>
</div>
