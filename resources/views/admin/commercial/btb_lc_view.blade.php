...
@section('title')
<title>{{ websiteTitle('BTB LC Details') }}</title>
@endsection

@section('contents')
<div class="breadcrumb-area">
    <h1>BTB LC Details</h1>
    <ol class="breadcrumb">
        <li class="item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a></li>
        <li class="item"><a href="{{ route('admin.commercial.btbLc') }}">Bank BTB LC</a></li>
...
<div class="card mb-30">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3>BTB LC: {{ $record->lc_no }}</h3>
        <div>
            <a href="{{ route('admin.commercial.btbLcAction', ['edit', $record->id]) }}" class="btn btn-success"><i class="bx bx-edit"></i> Edit</a>
            <a href="{{ route('admin.commercial.btbLc') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-borderless">
                    ...
                    <tr><th>Value Date</th><td>{{ $record->value_date ? \Carbon\Carbon::parse($record->value_date)->format('d M Y') : '' }}</td></tr>
                    ...
                    <tr><th>Created By</th><td>{{ $record->creator?$record->creator->name:'' }}</td></tr>
