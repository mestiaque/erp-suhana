...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
        ...
        <li class="item"><a href="{{route('admin.staffAdmin')}}">Staff List</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                        <form action="{{route('admin.staffAdminAction',['update',$user->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="media">
        ...
        <div class="col-md-5">
            <div class="card mb-30">
                ...
                <div class="card-body">
                    <form action="{{route('admin.staffAdminAction',['change-password',$user->id])}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col-xl-12 col-lg-12 col-md-12">
