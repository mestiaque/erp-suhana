            ...
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-1">
                                <div class="input-group">
                                    ...
                                    <a href="{{route('admin.staffAdmin', ['view' => 'deleted'])}}" class="btn-custom yellow" style="height: auto;">
                ...
                <div class="col-md-4">
                    <ul class="statuslist">
                        ...
                        <li><a href="{{route('admin.staffAdmin',['view'=>'deleted'])}}" target="_blank" class="text-danger" >Deleted ({{$totals->deleted}})</a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td style="padding: 8px 5px; text-align: center;">
                                @if(can('employee.delete'))
                                    <a href="{{ route('admin.staffAdminAction', ['restore', $user->id]) }}" class="btn-custom success" onclick="return confirm('Are you sure you want to restore this user?')">
                                        <i class="bx bx-reset"></i>
                                    </a>
                                    <a href="{{ route('admin.staffAdminAction', ['force-delete', $user->id]) }}" class="btn-custom danger" onclick="return confirm('Are you sure you want to permanently delete this user?')">
