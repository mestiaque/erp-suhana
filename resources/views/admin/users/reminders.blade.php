                    ...
                    <div class="card">
                        ...
                        <div class="reminderList">
                            ...
                            <div class="reminderGrid">
                                <div class="text">
                                    <h5>
                                        <b>Visit Date:</b> {{$visit->visit_date?Carbon\Carbon::parse($visit->visit_date)->format('d-m-Y h:i A'):''}} <b>Status:</b> {{ucfirst($visit->status)}}
                                    </h5>
                                    <p>
                                        <b>Assinee:</b> 
                                        @if($visit->type==1)
                                        ...
                                        @endif
                                        @if($visit->lead)
                                        <br><b>Lead:</b> <a href="{{route('admin.leadsAction',['view',$visit->lead->id])}}">{{$visit->lead->name}}</a>
                                        @endif
                                    </p>
                                    @if($visit->imageFile)
