...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
        ...
        <li class="item"><a href="{{route('admin.usersAdmin')}}">Employee List</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-30">
                <div class="card-header d-flex justify-content-between align-items-center">
                     ...
                     <a href="{{route('admin.usersAdminAction',['edit',$user->id])}}"  class="btn-custom yellow"><i class="bx bx-edit"></i> Edit</a>
                </div>
                <div class="card-body">

                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link {{$action=='view'?'active':''}}" href="{{route('admin.usersAdminAction',['view',$user->id])}}">Information</a>
                      </li>
