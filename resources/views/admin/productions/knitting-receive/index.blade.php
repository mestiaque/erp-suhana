...
@section('title')
<title>{{ websiteTitle('Knitting Receive List') }}</title>
@endsection
...
<div class="flex-grow-1">
    <div class="card mb-30">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Knitting Receive List</h3>
            <div class="dropdown">
                <a href="{{ route('admin.knittingReceiveAction','create') }}" class="btn-custom primary" style="padding:5px 15px;">
                    <i class="bx bx-plus"></i> Add Knitting Receive
                </a>
                <a href="{{ route('admin.knittingReceive') }}" class="btn-custom yellow">
        ...
        <div class="card-body">
            ...
            {{-- Search / Filter --}}
            <form method="GET" action="{{ route('admin.knittingReceive') }}">
                <div class="row mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center d-flex justify-content-center">
                                ...
                                <a href="{{ route('admin.knittingReceiveAction',['edit', $row->receive_no]) }}" class="btn-custom success mr-1">
                                    <i class="bx bx-edit"></i>
                                </a>
                                <a href="{{ route('admin.knittingReceiveAction',['delete', $row->receive_no]) }}"
                                   onclick="return confirm('Are You Sure To Delete?')" class="btn-custom danger">
    ...
    {{-- Details Modals --}}
    @include(adminTheme().'productions.knitting-receive.includes.details')
</div>
@endsection
