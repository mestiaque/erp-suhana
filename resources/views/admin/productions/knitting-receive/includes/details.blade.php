    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-header bg- text- py-2">
                <h5 class="modal-title">Knitting Booking Details #{{ $booking->getBookingNo() }}</h5>
            ...
            <div class="modal-body">
                ...
                <!-- Booking Items Table -->
                <h5 class="mb-2">Knitting Booking Items</h5>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            @php
                                $booking_items = \App\Models\KnittingBooking::where('booking_no', $booking->booking_no)->get();
                            @endphp
