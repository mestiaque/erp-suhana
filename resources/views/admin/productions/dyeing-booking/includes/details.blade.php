    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white py-2">
                <h5 class="modal-title text-white">Dyeing Booking Details #{{ $booking->getBookingNo() }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card bg-light border-0 mb-4">
                    <div class="card-body p-3">
                        <div class="row text-center">
                            ...
                            <div class="col-md-3 border-right">
                                <small class="text-muted d-block">Dyeing Unit/Factory</small>
                                <strong>{{ $row->dyeing_unit ?? '--' }}</strong>
                            </div>
                            <div class="col-md-3 border-right">
                ...
                <!-- Dyeing Items Table -->
                <h5 class="mb-3 font-weight- text-">
                    <i class="bx bx-list-ul"></i> Dyeing Booking Items
                </h5>
