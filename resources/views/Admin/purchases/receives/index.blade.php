...
@push('css')
<style>
.statuslist li { display:inline-block; margin-right:10px; }
</style>
@endpush
   ...
   <div class="modal-dialog">
     <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Input -->
            <input type="text" id="searchPurchaseNo" class="form-control" placeholder="Type Purchase Number">
...
$(function(){
    ...
    $('#createReceiveBtn').click(function(){
        ...
        $.post("{{ route('admin.purchasesReceivedAction', ['create']) }}",
            {_token: "{{ csrf_token() }}", purchase_no: no},
            function(res){
                if(res.success){
