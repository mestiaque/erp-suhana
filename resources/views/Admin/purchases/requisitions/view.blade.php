...
<div class="flex-grow-1">
    <div class="card mb-30">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Purchase Requisition View</h3>
            <div class="dropdown">
                ...
                <div class="invoice-container">
                    ...
                    <div class="inviceTitleId">
                        ...
                        <div class="invoice-dates">
                            <p><b>Request Date:</b> {{ $requisition->created_at->format('d.m.Y') }}</p>
                            <p><b>Expected Delivery:</b> {{ $requisition->expected_delivery_date ?? 'N/A' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="client-details">
                        ...
                        <p>Department: {{ $requisition->department->name ?? 'N/A' }}</p>
                    </div>
