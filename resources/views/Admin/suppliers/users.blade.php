...
<div class="card mb-30">
 ...
 <!-- Modal -->
 <div class="modal fade text-left" id="AddSupplier" tabindex="-1" role="dialog">
	   ...
	   <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control {{$errors->has('company_name')?'error':''}}" name="company_name" placeholder="Enter Company Name" >
            ...
            <div class="form-group">
				...
				<div class="controls">
					...
					<p style="color: red; margin: 0; font-size: 10px;">{{ $errors->first('email_mobile') }}</p>
					@endif
				</div>
            </div>
            <div class="form-group">
                <label for="address">Address Line</label>
                <input type="text" class="form-control {{$errors->has('address')?'error':''}}" name="address" placeholder="Enter Address" value="{{old('address')}}" />
            </div>
	   </div>
